...
/***/ function(module, exports, __webpack_require__) {
	...
	var _customerManagement = __webpack_require__(11);

	var _customerManagement2 = _interopRequireDefault(_customerManagement);
	 ...
	 */
	var store = (0, _redux.createStore)(_customerManagement2['default']);

	store.subscribe(function () {
	  console.log(store.getState());
	});

	store.dispatch((0, _action_creators.setCurrentCustomer)(1));

	store.dispatch((0, _action_creators.setCustomerStatus)(1, "Completely Satisfied"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _initial_stateJs = __webpack_require__(13);

	var _initial_stateJs2 = _interopRequireDefault(_initial_stateJs);

	var _action_creatorsJs = __webpack_require__(14);
	...
	function setCustomerStatus(state, customerId, status) {
	    return state.setIn(['customers', customerId, 'status'], status);
	}

	exports['default'] = function (state, action) {
	    if (state === undefined) state = _initial_stateJs2['default'];

	    switch (action.type) {
	        case _action_creatorsJs.SET_CURRENT_CUSTOMER:
	            return setCurrentCustomer(state, action.customerId);
	        case _action_creatorsJs.SET_CUSTOMER_STATUS:
...
/***/ function(module, exports) {
	...
	var SET_CURRENT_CUSTOMER = 'SET_CURRENT_CUSTOMER';
	exports.SET_CURRENT_CUSTOMER = SET_CURRENT_CUSTOMER;
	var SET_CUSTOMER_STATUS = 'SET_CUSTOMER_STATUS';

	exports.SET_CUSTOMER_STATUS = SET_CUSTOMER_STATUS;
